...
{
       0,   117,   117,   118,   121,   124,   125,   126,   127,   134,
     138,   144,   148,   174,   175,   178,   181,   189,   193,   201,
     205,   209,   216,   224,   244,   245,   258,   259,   281
};
#endif
...
static const char *const yytname[] =
{
  ...
  "t_ws", "t_ctl", "t_eof", "$accept", "allowed_char_for_token",
  "allowed_char_for_octet", "token", "all_octet", "allowed_char_for_text",
  "text", "ows", "request_line", "request_header", "request_header_all",
  "message_body", "request", YY_NULLPTR
};
#endif
...
{
       2,   -25,   -25,   -25,   -25,    52,     2,    14,    46,   -25,
      37,     2,    13,   -25,   -25,   -25,   -25,   -25,   -25,    18,
     -25,   -25,    10,   -25,    15,    46,    46,    34,   -25,   -25,
     -25,   -25,   -25,    15,   -25,     1,   -25,    46,   -25,   -25,
      34,    31,   -25
};
...
{
       0,     3,     4,     2,     9,     0,    24,     0,     0,    10,
      19,    24,     0,     1,    16,    15,    14,    13,    17,    19,
      20,    21,     0,    25,    26,     0,     0,    19,     7,     8,
       6,     5,    11,    27,    28,    19,    18,     0,    12,    22,
      19,     0,    23
};
...
{
       4,    22,    36,    35,    39,     9,     4,     1,     2,     3,
       9,     4,    20,    21,    13,    40,    24,    36,    37,    27,
       1,     2,     3,    38,    31,    28,    29,     5,    30,    25,
      21,    41,    23,    31,    42,    14,     1,     2,     3,     0,
      15,    16,     1,     2,     3,    20,    21,     0,    20,    21,
      14,     1,     2,     3,     0,    15,    16,     1,     2,     3,
       0,     0,     0,     8
};

static const yytype_int8 yycheck[] =
{
       0,    10,    26,    25,     3,     5,     6,     5,     6,     7,
      10,    11,    11,    12,     0,    37,     3,    41,    27,     9,
       5,     6,     7,    33,    24,    10,    11,     0,    13,    11,
      12,    40,    11,    33,     3,     4,     5,     6,     7,    -1,
       9,    10,     5,     6,     7,    11,    12,    -1,    11,    12,
...
{
       0,     5,     6,     7,    16,    18,    23,    27,    11,    16,
      18,    24,    25,     0,     4,     9,    10,    16,    20,    21,
      11,    12,    22,    25,     3,    11,    22,     9,    10,    11,
      13,    16,    17,    19,    26,    21,    20,    22,    17,     3,
      21,    22,     3
};
...
#line 193 "parser.y" /* yacc.c:1646  */
    {
	YPRINTF("text: Matched rule 2 %s%s%c.\n", (yyvsp[-2].str),(yyvsp[-1].str),(yyvsp[0].i));
...
#line 224 "parser.y" /* yacc.c:1646  */
	...
	YPRINTF("request_Header:\n%s\n%s\n header_count:%d\n",(yyvsp[-6].str),(yyvsp[-2].str), parsing_request->header_count);
...
#line 259 "parser.y" /* yacc.c:1646  */
	...
	if(strlen((yyvsp[0].str)) > parsing_request->body.capacity){
		parsing_request->body.data = malloc(sizeof(char)*(strlen((yyvsp[0].str))+1));
		parsing_request->body.capacity = strlen((yyvsp[0].str))+1;
	}
	strcpy(parsing_request->body.data, (yyvsp[0].str));
	parsing_request->body.length = strlen((yyvsp[0].str));
}
